...
Before unconditional production-soundness claims, an independent reviewer must audit composite-AIR constraint completeness, LogUp keys and multiplicities, matrix/noise/selective-opening binding, MoE routing, transcript order, FRI profiles, canonical-program folding, compact recursion, and verifier-key/setup digest coverage. The current dated audit record is [`../../ai-pow/docs/2026-07-17_DUAL_PUZZLE_CONSENSUS_AUDIT.md`](../../ai-pow/docs/2026-07-17_DUAL_PUZZLE_CONSENSUS_AUDIT.md).
