...
//! test time. The fixtures were generated by `tests/gen_fixtures.rs`, whose
//! vendored reference functions are derived from the Pearl repository and source
//! files documented in `LICENSE-PEARL`.
//!
