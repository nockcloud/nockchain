...
The claim is conditional on the composite AIR and recursive proof system being sound. Internal tests and audits do not replace independent cryptographic review.
...
The dated [dual-puzzle audit](2026-07-17_DUAL_PUZZLE_CONSENSUS_AUDIT.md) records implemented findings and regression evidence. Its remaining release gate is independent review of composite-AIR completeness, LogUp, matrix/noise/opening bindings, transcript order, FRI profiles, canonical-program folding, recursion, and setup-digest coverage.
